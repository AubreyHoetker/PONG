...
export var wallSound = new soundFile("Walls.mp3"); //load sound
soundArray.push(wallSound); //add sound to list of sounds

export var paddleSound = new soundFile("Paddles.mp3");
soundArray.push(paddleSound);

export var scoreSound = new soundFile("Score.mp3");
soundArray.push(scoreSound);

export var ambientSound = new soundFile("Ambience2.mp3");
